...
8. **sentiment**: Sentimiento general de la noticia (NO del tono de los medios). ¿Los hechos en sí son positivos, negativos o neutros para la sociedad? SOLO uno de: "positive", "negative", "neutral". Ejemplos: un atentado → "negative", una bajada del paro → "positive", una reunión diplomática sin consecuencias → "neutral".
